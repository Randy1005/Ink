...
---
## Round 36 — adaptive d0=2.0 tpps=50000 up=2.5 dn=0.7

**Phase 2** | Config ID 36
...
| benchmark | time_ms | avg_err | max_err | steps | avg_pps | d_min | d_max |
|---|---|---|---|---|---|---|---|
| leon2 | 58.8 | 0.0000 | 0.0000 | 1 | 1299420 | 2.000 | 2.000 |
| leon3mp | 42.3 | 0.0000 | 0.0000 | 1 | 1001296 | 2.000 | 2.000 |
| netcard | 52.8 | 0.0000 | 0.0000 | 1 | 1200332 | 2.000 | 2.000 |
...
---
## Round 37 — adaptive d0=2.0 tpps=50000 up=2.5 dn=0.9

**Phase 2** | Config ID 37
...
| benchmark | time_ms | avg_err | max_err | steps | avg_pps | d_min | d_max |
|---|---|---|---|---|---|---|---|
| leon2 | 58.1 | 0.0000 | 0.0000 | 1 | 1299420 | 2.000 | 2.000 |
| leon3mp | 43.4 | 0.0000 | 0.0000 | 1 | 1001296 | 2.000 | 2.000 |
| netcard | 52.9 | 0.0000 | 0.0000 | 1 | 1200332 | 2.000 | 2.000 |
...
---
## Round 38 — adaptive d0=2.0 tpps=200000 up=1.5 dn=0.7

**Phase 2** | Config ID 38
...
| benchmark | time_ms | avg_err | max_err | steps | avg_pps | d_min | d_max |
|---|---|---|---|---|---|---|---|
| leon2 | 55.6 | 0.0000 | 0.0000 | 1 | 1299420 | 2.000 | 2.000 |
| leon3mp | 43.6 | 0.0000 | 0.0000 | 1 | 1001296 | 2.000 | 2.000 |
| netcard | 55.0 | 0.0000 | 0.0000 | 1 | 1200332 | 2.000 | 2.000 |
...
---
## Round 39 — adaptive d0=2.0 tpps=200000 up=1.5 dn=0.9

**Phase 2** | Config ID 39
...
| benchmark | time_ms | avg_err | max_err | steps | avg_pps | d_min | d_max |
|---|---|---|---|---|---|---|---|
| leon2 | 57.6 | 0.0000 | 0.0000 | 1 | 1299420 | 2.000 | 2.000 |
| leon3mp | 44.5 | 0.0000 | 0.0000 | 1 | 1001296 | 2.000 | 2.000 |
| netcard | 52.6 | 0.0000 | 0.0000 | 1 | 1200332 | 2.000 | 2.000 |

**Avg time across benchmarks:** 51.6 ms

**Verdict:** 🔻 regression   (50.2 → 51.6 ms avg)

**Best so far:** static delta=2.0 @ 50.20000000000001 ms

---
## Round 40 — adaptive d0=2.0 tpps=200000 up=2.5 dn=0.7

**Phase 2** | Config ID 40
...
| benchmark | time_ms | avg_err | max_err | steps | avg_pps | d_min | d_max |
|---|---|---|---|---|---|---|---|
| leon2 | 57.8 | 0.0000 | 0.0000 | 1 | 1299420 | 2.000 | 2.000 |
| leon3mp | 43.8 | 0.0000 | 0.0000 | 1 | 1001296 | 2.000 | 2.000 |
| netcard | 52.5 | 0.0000 | 0.0000 | 1 | 1200332 | 2.000 | 2.000 |
...
---
## Round 41 — adaptive d0=2.0 tpps=200000 up=2.5 dn=0.9

**Phase 2** | Config ID 41
...
| benchmark | time_ms | avg_err | max_err | steps | avg_pps | d_min | d_max |
|---|---|---|---|---|---|---|---|
| leon2 | 55.7 | 0.0000 | 0.0000 | 1 | 1299420 | 2.000 | 2.000 |
| leon3mp | 43.4 | 0.0000 | 0.0000 | 1 | 1001296 | 2.000 | 2.000 |
| netcard | 51.1 | 0.0000 | 0.0000 | 1 | 1200332 | 2.000 | 2.000 |

**Avg time across benchmarks:** 50.1 ms

**Verdict:** ➖ plateau      (50.1 ms avg)

**Best so far:** static delta=2.0 @ 50.20000000000001 ms

---
## Round 42 — adaptive d0=2.0 tpps=500000 up=1.5 dn=0.7

**Phase 2** | Config ID 42
...
**Avg time across benchmarks:** 51.7 ms
...
---
## Round 44 — adaptive d0=2.0 tpps=500000 up=2.5 dn=0.7

**Phase 2** | Config ID 44
...
| benchmark | time_ms | avg_err | max_err | steps | avg_pps | d_min | d_max |
|---|---|---|---|---|---|---|---|
| leon2 | 57.5 | 0.0000 | 0.0000 | 1 | 1299420 | 2.000 | 2.000 |
| leon3mp | 43.6 | 0.0000 | 0.0000 | 1 | 1001296 | 2.000 | 2.000 |
| netcard | 51.2 | 0.0000 | 0.0000 | 1 | 1200332 | 2.000 | 2.000 |

**Avg time across benchmarks:** 50.8 ms

**Verdict:** 🔻 regression   (50.2 → 50.8 ms avg)

**Best so far:** static delta=2.0 @ 50.20000000000001 ms

---
## Round 45 — adaptive d0=2.0 tpps=500000 up=2.5 dn=0.9

**Phase 2** | Config ID 45
...
| benchmark | time_ms | avg_err | max_err | steps | avg_pps | d_min | d_max |
|---|---|---|---|---|---|---|---|
| leon2 | 56.8 | 0.0000 | 0.0000 | 1 | 1299420 | 2.000 | 2.000 |
| leon3mp | 43.9 | 0.0000 | 0.0000 | 1 | 1001296 | 2.000 | 2.000 |
| netcard | 52.7 | 0.0000 | 0.0000 | 1 | 1200332 | 2.000 | 2.000 |

**Avg time across benchmarks:** 51.1 ms

**Verdict:** 🔻 regression   (50.2 → 51.1 ms avg)
